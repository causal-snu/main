...
df1_c=df0
df0
cart2=rpart(poisox~ age+sex, data=df1_c ,method='poisson')
summary(cart2)
cart2$control
...
#for (i in 1:nrow(df1) ){df1_c[i,"ps2"]=cart_ps2[i,"1"]}
...
?rpart
cart2=rpart(poisox~ age+sex+blood_diff, data=df1_c ,method='class')
summary(cart2)
...
cart2=ps_cart(poisox ~ age + sex+blood_diff, data = df3)
cart_ps2=estimate_ps(cart2)
df3["propensity score"]=cart_ps2
df3 %>% head()
...
par(mfcol=c(1,3))
boxplot(df_lo[(df0$poisox==0),"ipw_wt"],main="LR in Chemical")
boxplot(df_rf[(df0$poisox==0),"ipw_wt"],main="RF in Chemical")
boxplot(df1_c[(df0$poisox==0),"ipw_wt"],main="CART in Chemical")
